# -*- coding: utf-8 -*-
"""
Created on Mon Sep 07 11:55:18 2015
...
# Superclass with more functionality
class ReadInput:
    def __init__(self, parameters):
        self.p = parameters
    ...
    def set_value(self, **name_value_pairs):
...
# Subclass for reading input data from raw_input() function
...
# Subclass for reading input data from a file
...
# Subclass for reading input data from the command line
class ReadCommandLine(ReadInput):
    ...
    def _read_command_line(self):
        ...
        for name in self.p:
            ...
            # Parameter type is not specified. So default type is string.
            # Convert string to correct object with str2obj()
...
try:
    ...
    print 'The Pmw Python package is not installed!'
    sys.exit(1)
...
__all__ = ['ReadInput', 'PromptUser', 'ReadInputFile', 'ReadCommandLine', 'GUI', '_test1']